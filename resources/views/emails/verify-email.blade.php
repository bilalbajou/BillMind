    ...
    <div class="wrapper">
        <div class="main">
            <div class="header">
                ...
                <h1
                    style="color: #4F46E5; font-size: 28px; font-weight: 800; margin: 0; display: flex; align-items: center; justify-content: center; gap: 8px;">
                    @if(file_exists(public_path('logo.png')))
                        <img src="{{ $message->embed(public_path('logo.png')) }}" alt="BillMind"
                            style="height: 96px; width: auto;" />
                    @else
                        <span
                            style="background-color: #4F46E5; color: white; border-radius: 8px; padding: 4px 8px; font-size: 20px; font-weight: bold;">B</span>
                        BillMind
                    @endif
                </h1>
            </div>
            ...
            <div class="content">
                ...
                <p class="text">
                    ...
                    Before you can start managing your invoices with AI, please verify your email address by clicking
                    the button below.
                </p>
